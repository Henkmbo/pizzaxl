...
<div class="app-ui js-app-ui">
                    ...
                    <ul class="sidenav__list">
                        ...
                        <li class="sidenav__item sidenav__item--expanded">
                            ...
                            <ul class="sidenav__list">
                                ...
                                <li class="sidenav__item">
                                    <a href="<?=URLROOT?>/Store/overview/" class="sidenav__link" aria-current="page">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg"><?= $data['store']->storeName; ?></h1>
        </div>
                ...
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        ...
                        <span class="color-contrast-low margin-left-xxs"
                            aria-hidden="true"><?= $data['store']->storeId; ?></span>
                    </li>
        ...
        <div class="bg radius-md shadow-xs">
                ...
                <div class="padding-md">
                    ...
                    <fieldset class="margin-bottom-xl">
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg" for="storeName">storeName</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="text" name="storeName"
                                        id="storeName" value="<?= $data['store']->storeName; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            ...
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="text" name="storeCity"
                                        id="storeCity" value="<?= $data['store']->storeCity; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg" for="storePhone">Phone</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="number" name="storePhone"
                                        id="storePhone" value="<?= $data['store']->storePhone; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="text" name="storeEmail"
                                        id="storeEmail" value="<?= $data['store']->storeEmail; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
            ...
            <form action="<?= URLROOT; ?>Store/updateImage/<?= $data['store']->storeId ?>"
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1"
        ...
        <footer class="margin-top-md">
            <div class="flex justify-end gap-xs flex-wrap">
                ...
                <a href="<?= URLROOT; ?>Store/deleteImage/<?= $data['image']->screenId . "+" . $data['store']->storeId?>" class="btn btn--accent">Delete</a>
            </div>
        </footer>
    </div>
</div>
