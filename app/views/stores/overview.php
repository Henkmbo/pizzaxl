...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <a href="<?=URLROOT?>Store/create" class="btn btn--primary">+ New Store</a>
        <br>
        <br>
        <!-- interactive table -->
        <div class="bg radius-md padding-md inner-glow shadow-xs">
                ...
                <div class="int-table__inner">
                    <table class="int-table__table" aria-label="Interactive table example">
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['stores'] as $stores) : ?>
                            <tr class="int-table__row">
                                ...
                                <td class="int-table__cell"><?= $stores->storeId ?></td>
                                <td class="int-table__cell"><?= $stores->storeName ?></td>
                                <td class="int-table__cell"><?= $stores->storeStreetName ?></td>
                                <td class="int-table__cell"><?= $stores->storeCity ?></td>
                                <td class="int-table__cell"><?= $stores->storePhone ?></td>
                                <td class="int-table__cell"><?= $stores->storeEmail ?></td>
                                <td class="int-table__cell"><?= $stores->storeZipcode ?></td>
                                <td class="int-table__cell"><?= date('d/m/Y', $stores->storeCreateDate) ?></td>
                                <td class="int-table__cell">
                                    <a href="<?= URLROOT ?>Store/employees/<?= $stores->storeId ?>">Employees</a>
                                </td>
                                <td class="int-table__cell">
                                    <a href="<?= URLROOT ?>Store/vehicles/<?= $stores->storeId ?>">Vehicles</a>
                                </td>
                                <td class="int-table__cell">
                                    <a href="<?= URLROOT ?>Store/update/<?= $stores->storeId ?>">update</a>
                                </td>
                                <td class="int-table__cell">
                                    <a
                                        href="<?= URLROOT ?>/Store/delete/<?= $stores->storeId ?>">Delete</a>
                                </td>
                                <td class="int-table__cell">
            ...
            <div class="flex items-center justify-between padding-top-sm">
                <p class="text-sm"><?= $data['totalStores'] ?> Results</p>
                    ...
                    <ul class="pagination__list flex gap-xxxs">
                        ...
                        <li>
                            <span class="pagination__jumper flex items-center">
                                ...
                                <em>of <?= htmlspecialchars(ceil($data['totalStores'] / $data['perPage'])) ?></em>
                            </span>
                        </li>

                        <?php if ($data['currentPage'] < ceil($data['totalStores'] / $data['perPage'])) : ?>
                        <li>
                            <a href="?page=<?= $data['currentPage'] + 1 ?>" class="pagination__item">
                                <svg class="icon" viewBox="0 0 16 16">
