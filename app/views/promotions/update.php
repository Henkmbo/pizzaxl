...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg"><?= $data['promotions']->promotionId; ?></h1>
        </div>
                ...
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        ...
                        <span class="color-contrast-low margin-left-xxs"
                            aria-hidden="true"><?= $data['promotions']->promotionId; ?></span>
                    </li>
        ...
        <div class="bg radius-md shadow-xs">
                            ...
                            <div class="grid gap-xxs">
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="hidden" name="id" id="id"
                                        value="<?= $data['promotions']->promotionId; ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="promotionName">Name</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="text" max="5" min="0"
                                        name="promotionName" id="promotionName"
                                        value="<?= $data['promotions']->promotionName; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg" for="promotionStartDate">Start
                                        Date</label>
                                </div>

                                <div class="col-6@lg">
                                    <?php $promotionStartDate = date('Y-m-d', $data['promotions']->promotionStartDate) ?>
                                    <input class="form-control width-100%" type="date" name="promotionStartDate"
                                        id="promotionStartDate" value="<?= $promotionStartDate; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg" for="promotionEndDate">End
                                        Date</label>
                                </div>

                                <div class="col-6@lg">
                                    <?php $promotionEndDate = date('Y-m-d', $data['promotions']->promotionEndDate) ?>
                                    <input class="form-control width-100%" type="date" name="promotionEndDate"
                                        id="promotionEndDate" value="<?= $promotionEndDate; ?>">
                                </div>
                            </div>
                        </div>
                    </fieldset>
            ...
            <form action="<?= URLROOT; ?>Promotion/updateImage/<?= $data['promotions']->promotionId ?>" method="post"
    ...
    <div class="dialog dialog--sticky js-dialog" id="dialog-delete-user-confirmation-<?= $image->screenId ?>" data-animation="on">
        <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1" aria-describedby="dialog-description">
            <div class="text-component">
                ...
                <p id="dialog-description"><?= $image->screenId ?>.</p>
            </div>
            <footer class="margin-top-md">
                <div class="flex justify-end gap-xs flex-wrap">
                    <button class="btn btn--subtle js-dialog__close">Cancel</button>
                    <a href="<?= URLROOT; ?>Promotion/deleteImage/<?= $image->screenId . "+" . $data['promotions']->promotionId?>" class="btn btn--accent">Delete</a>
                </div>
            </footer>
        </div>
    </div>
