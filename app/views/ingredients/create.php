            ...
            <nav class="breadcrumbs text-sm" aria-label="Breadcrumbs">
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        <a href="<?= URLROOT?>/Ingredient/index" class="color-inherit">All Ingredients</a>
                    ...
                    <fieldset class="margin-bottom-xl">
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" min="0" step="0.01" type="number" name="ingredientPrice" id="ingredientPrice" placeholder="0,00"
                                    value="">
                                </div>
                            </div>
                        </div>
