...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
            ...
            <nav class="breadcrumbs text-sm" aria-label="Breadcrumbs">
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        <a href="<?= URLROOT?>/Ingredient/overview" class="color-inherit">All Ingredients</a>
                        <span class="color-contrast-low margin-left-xxs"
                            aria-hidden="true"><?= $data['ingredient']->ingredientId; ?></span>
                    </li>
                            ...
                            <div class="grid gap-xxs">
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="hidden" name="id" id="id"
                                        value="<?= $data['ingredient']->ingredientId; ?>">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="ingredientName">Name</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="text" name="ingredientName"
                                        id="ingredientName" value="<?= $data['ingredient']->ingredientName; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="number" name="ingredientPrice"
                                        id="ingredientPrice" step="0.01"
                                        value="<?= $data['ingredient']->ingredientPrice; ?>">
                                </div>
                            </div>
                        </div>
                    </fieldset>
        ...
        <form action="<?= URLROOT; ?>Ingredient/updateImage/<?= $data['ingredient']->ingredientId ?>" method="post" enctype="multipart/form-data">
            <div class="padding-md">
                <!-- Basic form controls -->
                <fieldset class="margin-bottom-xl">
                    <div class="margin-bottom-sm">
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1"
        ...
        <footer class="margin-top-md">
            <div class="flex justify-end gap-xs flex-wrap">
                ...
                <a href="<?= URLROOT; ?>Ingredient/deleteImage/<?= $data['image']->screenId . "+" . $data['ingredient']->ingredientId?>" class="btn btn--accent">Delete</a>
            </div>
        </footer>
    </div>
</div>
    ...
    <ul class="notif text-sm">
        <li class="notif__item ">
            <a class="notif__link flex padding-sm" href="#0">
                ...
                <div class="flex-gingrow margin-right-xs">
                    <div>
