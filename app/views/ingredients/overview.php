...
<div class="app-ui js-app-ui">
                    ...
                    <ul class="sidenav__list">
                        ...
                        <li class="sidenav__item sidenav__item--expanded">
                            ...
                            <ul class="sidenav__list">
                                ...
                                <li class="sidenav__item">
                                    <a href="<?=URLROOT?>/Ingredient/overview/" class="sidenav__link" aria-current="page">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <a href="<?=URLROOT?>/Ingredient/create" class="btn btn--primary">+ New Ingredient</a>
<br>
<br>
        <!-- interactive table -->
        <div class="bg radius-md padding-md inner-glow shadow-xs">
                ...
                <div class="int-table__inner">
                    <table class="int-table__table" aria-label="Interactive table example">
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['ingredients'] as $ingredients) : ?>
                            <tr class="int-table__row">
                                ...
                                <td class="int-table__cell"><?= $ingredients->ingredientId ?></td>
                                <td class="int-table__cell"><?= $ingredients->ingredientName ?></td>
                                <td class="int-table__cell"><?= $ingredients->ingredientPrice ?></td>
                                <td class="int-table__cell"><?= date('d/m/Y', $ingredients->ingredientCreatedate) ?></td>
                                <td class="int-table__cell"><a href="<?= URLROOT ?>Ingredient/update/<?= $ingredients->ingredientId ?>">update</a></td>
            ...
            <div class="flex items-center justify-between padding-top-sm">
                <p class="text-sm"><?= $data['totalIngredienten'] ?> Results</p>
                    ...
                    <ul class="pagination__list flex gap-xxxs">
                        ...
                        <li>
                            <span class="pagination__jumper flex items-center">
                                ...
                                <em>of <?= htmlspecialchars(ceil($data['totalIngredienten'] / $data['perPage'])) ?></em>
                            </span>
                        </li>

                        <?php if ($data['currentPage'] < ceil($data['totalIngredienten'] / $data['perPage'])) : ?>
                        <li>
                            <a href="?page=<?= $data['currentPage'] + 1 ?>" class="pagination__item">
                                <svg class="icon" viewBox="0 0 16 16">
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1" aria-describedby="dialog-description">
      ...
      <footer class="margin-top-md">
        <div class="flex justify-end gap-xs flex-wrap">
          ...
          <a  class="btn btn--accent" href="<?= URLROOT ?>Ingredient/delete/<?= $ingredients->ingredientId ?>">Delete</a>
        </div>
      </footer>
    </div>
  </div>
