...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg"><?= $data['customer']->customerFirstName; ?> <?= $data['customer']->customerLastName; ?>
            </h1>
        </div>
                ...
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        ...
                        <span class="color-contrast-low margin-left-xxs"
                            aria-hidden="true"><?= $data['customer']->customerId; ?></span>
                    </li>
        ...
        <div class="bg radius-md shadow-xs">
                    ...
                    <fieldset class="margin-bottom-xl">
                            ...
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="customerFirstName">FirstName</label>
                                </div>
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="customerLastName">LastName</label>
                                </div>
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="customerStreetName">StreetName</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="text" name="customerStreetName"
                                        id="customerStreetName" value="<?= $data['customer']->customerStreetName; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="text" name="customerCity"
                                        id="customerCity" value="<?= $data['customer']->customerCity; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="customerZipCode">ZipCode</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="text" name="customerZipCode"
                                        id="customerZipCode" value="<?= $data['customer']->customerZipCode; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="customerPhone">Phone</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="number" name="customerPhone"
                                        id="customerPhone" value="<?= $data['customer']->customerPhone; ?>">
                                </div>
                            </div>
                        </div>
                        <!-- input email -->
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="email" name="customerEmail"
                                        id="customerEmail" value="<?= $data['customer']->customerEmail; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="customerType">Type</label>
                                </div>

                                <div class="col-6@lg">
                                    <div class="select">
                                        <select class="select__input form-control" name="customerType"
                                            id="customerType">
                                            <option><?php echo $data['customer']->customerType; ?></option>
                                            <option><?php echo $data['customer']->customerType; ?></option>
                                        </select>
            ...
            <form action="<?= URLROOT; ?>Customer/updateImage/{customerId:<?= $data['customer']->customerId ?>}" method="post" enctype="multipart/form-data">
        <div class="padding-md">
            <!-- basic form controls -->
            <fieldset class="margin-bottom-xl">
                <div class="margin-bottom-sm">
                    ...
                    <div class="margin-bottom-sm">
                        <div class="grid gap-xxs">
                            <div class="col-3@lg">
                                <label class="inline-block text-sm padding-top-xs@lg" for="file"></label>
                            </div>
                            <div class="col-6@lg">
                                ...
                                <?php if ($data['imageSrc'] && $data['imageSrc'] !== URLROOT . 'public/default-image.jpg') : ?>
                                    <br>
                                    <a href="#" aria-controls="dialog-delete-user-confirmation" class="btn btn-delete">Delete Image</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<div data-toast-interval='2000' class="toast toast--hidden toast--top-right js-toast" role="alert" aria-live="assertive"
    ...
    <div class="flex items-start justify-between">
        ...
        <div class="text-component text-sm">
            ...
            <p class="toast__p">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Explicabo esse maiores
                assumenda.</p>
        </div>
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1"
        ...
        <footer class="margin-top-md">
            <div class="flex justify-end gap-xs flex-wrap">
                ...
                <a class="btn btn--accent" href="<?= URLROOT; ?>Customer/deleteImage/{screenId:<?= $data['image']->screenId . ";" . 'customerId:' . $data['customer']->customerId?>}">Delete</a>
            </div>
        </footer>
    </div>
</div>
