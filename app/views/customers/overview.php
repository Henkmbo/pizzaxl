                    ...
                    <ul class="sidenav__list">
                        ...
                        <li class="sidenav__item sidenav__item--expanded">
                            ...
                            <ul class="sidenav__list">
                                ...
                                <li class="sidenav__item">
                                    <a href="<?= URLROOT ?>/Customer/overview/" class="sidenav__link" aria-current="page">
                                ...
                                <li class="sidenav__item">
                                    <a href="<?= URLROOT ?>/Promotion
/overview/" class="sidenav__link">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <a href="<?= URLROOT ?>/Customer/create" class="btn btn--primary">+ New User</a>
        <br>
        <br>
        <!-- interactive table -->
        <div class="bg radius-md padding-md inner-glow shadow-xs">
                    ...
                    <table class="int-table__table" aria-label="Interactive table example">
                        <thead class="int-table__header js-int-table__header">
                            <tr class="int-table__row">
                                ...
                                <th class="int-table__cell int-table__cell--th int-table__cell--sort js-int-table__cell--sort" data-date-format="">
                                    <div class="flex items-center">
                                        <span>Email</span>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['customers'] as $customers) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell"><?= $customers->customerId ?></td>
                                    <td class="int-table__cell"><?= $customers->customerFirstName ?>
                                        <?= $customers->customerLastName ?></td>
                                    <td class="int-table__cell"><?= $customers->customerStreetName ?></td>
                                    <td class="int-table__cell text-truncate max-width-xxxxs">
                                        <?= $customers->customerCity ?></td>
                                    <td class="int-table__cell"><?= $customers->customerZipCode ?></td>
                                    <td class="int-table__cell"><?= $customers->customerPhone ?></td>
                                    <td class="int-table__cell"><?= $customers->customerEmail ?></td>
                                    <td class="int-table__cell"><?= $customers->customerType ?></td>
                                    <td class="int-table__cell"><?= date('d/m/Y', $customers->Customercreatedate) ?></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>Customer/update/{customerId:<?= $customers->customerId ?>}">update</a>
                                    </td>
                                    <td class="int-table__cell"><a aria-controls="dialog-delete-user-confirmation" href="#">Delete</a></td>
                                    <td class="int-table__cell">
                                        <button class="reset int-table__menu-btn margin-left-auto js-tab-focus" data-label="update row" aria-controls="menu-example">
            ...
            <div class="flex items-center justify-between padding-top-sm">
                <p class="text-sm"><?= $data['activeCustomers'] ?> Results</p>
...
<div id="modal-name-1" class="modal modal--animate-scale flex flex-center bg-black bg-opacity-90% padding-md js-modal">
    <div class="modal__content width-100% max-width-xs max-height-100% overflow-auto bg radius-md inner-glow shadow-md" role="alertdialog" aria-labelledby="modal-title-1" aria-describedby="modal-description-1">
        <header class="bg-contrast-lower bg-opacity-50% padding-y-sm padding-x-md flex items-center justify-between">
            <h1 id="modal-title-1" class="text-truncate text-md">Modal title</h1>
        ...
        <div class="padding-y-sm padding-x-md">
            <div class="text-component">
                <p id="modal-description-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae culpa,
                    inventore alias ab atque similique quod ea reprehenderit.</p>
            </div>
        </div>
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1" aria-describedby="dialog-description">
        ...
        <footer class="margin-top-md">
            <div class="flex justify-end gap-xs flex-wrap">
                ...
                <a class="btn btn--accent" href="<?= URLROOT ?>Customer/delete/{customerId:<?= $customers->customerId ?>}">Delete</a>
            </div>
        </footer>
    </div>
</div>
