...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <a href="<?=URLROOT?>Order/create" class="btn btn--primary">+ New Order</a>
        <br>
        <br>
        <!-- interactive table -->
        <div class="bg radius-md padding-md inner-glow shadow-xs">
                    ...
                    <table class="int-table__table" aria-label="Interactive table example">
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            ...
                            <tr class="int-table__row">
                                ...
                                <td class="int-table__cell"><?= $orders->orderId ?></td>
                                <td class="int-table__cell"><?= $orders->storeName ?></td>
                                <td class="int-table__cell"><?= $orders->orderState ?></td>
                                <td class="int-table__cell"><?= $orders->customerFirstName ?></td>
                                <td class="int-table__cell"><?= $orders->orderStatus ?></td>
                                <td class="int-table__cell"><?= $orders->orderPrice ?></td>
                                <td class="int-table__cell"><?= date('d/m/Y', $orders->orderCreatedate) ?></td>
                                <td class="int-table__cell">
                                    <a href="<?= URLROOT ?>Order/read/<?= $orders->orderId ?>">Read</a>
                                </td>
                                <td class="int-table__cell">
                                    <a href="<?= URLROOT ?>Order/update/<?= $orders->orderId ?>">update</a>
                                </td>
            ...
            <div class="flex items-center justify-between padding-top-sm">
                <p class="text-sm"><?= $data['activeOrders'] ?> Results</p>
                    ...
                    <ul class="pagination__list flex gap-xxxs">
                        ...
                        <li>
                            <span class="pagination__jumper flex items-center">
                                ...
                                <em>of <?= htmlspecialchars($data['totalPages']) ?></em>
                            </span>
                        </li>
                        <?php if ($data['currentPage'] < ceil($data['activeOrders'] / $data['perPage'])) : ?>
                        <li>
                        <a href="?page=<?= $data['currentPage'] + 1 ?>" class="pagination__item">
                                <svg class="icon" viewBox="0 0 16 16">
