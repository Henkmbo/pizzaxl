            ...
            <nav class="breadcrumbs text-sm" aria-label="Breadcrumbs">
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        <a href="<?= URLROOT?>/Order/index" class="color-inherit">All Orders</a>
                    ...
                    <fieldset class="margin-bottom-xl">
                            ...
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="orderStoreId">Storename</label>
                                </div>
                                <div class="col-6@lg">
                                    <div class="select">
                                        <select class="select__input form-control" name="orderStoreId"
                                            id="orderStoreId">
                                            <?php foreach ($data['stores'] as $stores) : ?>
                                            <option value="<?= $stores->storeId ?>">
                                                <?= $stores->storeName ?></option>
                                            <?php endforeach; ?>
                                        </select>
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="orderCustomerId">Customer</label>
                                </div>
                                <div class="col-6@lg">
                                    <div class="select">
                                        <select class="select__input form-control" name="orderCustomerId"
                                            id="orderCustomerId">
                                            <?php foreach ($data['customers'] as $customer) : ?>
                                            <option value="<?= $customer->customerId ?>">
                                                <?= $customer->customerFirstName ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <svg class="icon select__icon" aria-hidden="true" viewBox="0 0 16 16">
                                            <polyline points="1 5 8 12 15 5" fill="none" stroke="currentColor"
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="orderPrice">orderPrice</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="number" step="0.01" placeholder="0.00"
                                        name="orderPrice" id="orderPrice" value="">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
