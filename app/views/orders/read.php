...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg">Products by order</h1>
        </div>
        <br>
        <br>
        <!-- interactive table -->
                ...
                <div class="int-table__inner">
                    <table class="int-table__table" aria-label="Interactive table example">
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['productByOrder'] as $productByOrder) : ?>
                            <tr class="int-table__row">
                                ...
                                <td class="int-table__cell"><?= $productByOrder->orderId ?></td>
                                <td class="int-table__cell"><?= $productByOrder->productname ?></td>
                                <td class="int-table__cell"><?= $productByOrder->productPrice ?></td>
                                <td class="int-table__cell"><?= $productByOrder->productType ?></td>
                                <td class="int-table__cell"><?= date('d/m/Y', $productByOrder->orderCreatedate) ?></td>
                                <td class="int-table__cell">
