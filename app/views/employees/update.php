...
<div class="app-ui js-app-ui">
                ...
                <nav class="sidenav padding-y-sm js-sidenav">
                    ...
                    <ul class="sidenav__list">
                        ...
                        <li class="sidenav__item sidenav__item--expanded">
                            ...
                            <ul class="sidenav__list">
                                <li class="sidenav__item">
                                    <a href="<?=URLROOT?>/Employee/overview/" class="sidenav__link" aria-current="page">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg"><?= $data['employee']->employeeFirstName; ?> <?= $data['employee']->employeeLastName; ?></h1>
        </div>
            ...
            <nav class="breadcrumbs text-sm" aria-label="Breadcrumbs">
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        ...
                        <span class="color-contrast-low margin-left-xxs" aria-hidden="true"><?= $data['employee']->employeeId; ?></span>
                    </li>
        ...
        <form action="<?= URLROOT; ?>/Employee/update" method="post">
                    ...
                    <fieldset class="margin-bottom-xl">
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    ...
                                    value="<?= $data['employee']->employeeFirstName; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    ...
                                    value="<?= $data['employee']->employeeLastName; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    ...
                                    value="<?= $data['employee']->employeeStreetName; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    ...
                                    value="<?= $data['employee']->employeeCity; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    ...
                                    value="<?= $data['employee']->employeeZipCode; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="number" name="employeePhone"
                                        id="employeePhone"                                   
                            ...
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="employeeEmail">Email</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="email" name="employeeEmail"
                                        id="employeeEmail" 
                                        value="<?= $data['employee']->employeeEmail; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <div class="select">
                                        <select class="select__input form-control" name="employeeRole"
                                            id="employeeRole">
                                            <option value="<?= $data['employee']->employeeRole; ?>">Manager</option>
                                        </select>
            ...
            <form action="<?= URLROOT; ?>Employee/updateImage/<?= $data['employee']->employeeId ?>" method="post" enctype="multipart/form-data">
        <div class="padding-md">
            <!-- basic form controls -->
            <fieldset class="margin-bottom-xl">
                <div class="margin-bottom-sm">
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1"
        ...
        <footer class="margin-top-md">
            <div class="flex justify-end gap-xs flex-wrap">
                ...
                <a href="<?= URLROOT; ?>Employee/deleteImage/<?= $data['image']->screenId . "+" . $data['employee']->employeeId?>" class="btn btn--accent">Delete</a>
            </div>
        </footer>
    </div>
</div>
