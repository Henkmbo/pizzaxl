...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <a href="<?=URLROOT?>Employee/create" class="btn btn--primary">+ New User</a>
        <br>
        <br>
        <!-- interactive table -->
        <div class="bg radius-md padding-md inner-glow shadow-xs">
                    ...
                    <table class="int-table__table" aria-label="Interactive table example">
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            ...
                            <tr class="int-table__row">
                                ...
                                <td class="int-table__cell"><?= $employees->employeeId ?></td>
                                <td class="int-table__cell"><?= $employees->employeeFirstName ?>
                                    <?= $employees->employeeLastname ?></td>
                                <td class="int-table__cell"><?= $employees->employeeEmail ?></td>
                                <td class="int-table__cell text-truncate max-width-xxxxs">
                                    <?= $employees->employeeCity ?></td>
                                <td class="int-table__cell"><?= $employees->employeePhone ?></td>
                                <td class="int-table__cell"><?= $employees->employeeRole ?></td>
                                <td class="int-table__cell"><?= date('d/m/Y', $employees->employeeCreateDate) ?></td>
                                <td class="int-table__cell"><a
                                        href="<?= URLROOT ?>Employee/update/<?= $employees->employeeId ?>">update</a>
                                </td>
            ...
            <div class="flex items-center justify-between padding-top-sm">
                <p class="text-sm"><?= $data['activeEmployee'] ?> Results</p>
                    ...
                    <ul class="pagination__list flex gap-xxxs">
                        ...
                        <li>
                            <span class="pagination__jumper flex items-center">
                                ...
                                <em>of <?= htmlspecialchars(ceil($data['activeEmployee'] / $data['perPage'])) ?></em>
                            </span>
                        </li>
                        <?php if ($data['currentPage'] < ceil($data['activeEmployee'] / $data['perPage'])) : ?>
                        <li>
                            <a href="?page=<?= $data['currentPage'] + 1 ?>" class="pagination__item">
                                <svg class="icon" viewBox="0 0 16 16">
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1" aria-describedby="dialog-description">
      ...
      <footer class="margin-top-md">
        <div class="flex justify-end gap-xs flex-wrap">
          ...
          <a class="btn btn--accent" href="<?= URLROOT ?>Employee/delete/<?= $employees->employeeId ?>">Delete</a>
        </div>
      </footer>
    </div>
  </div>
