...
<div class="app-ui js-app-ui">
                    ...
                    <ul class="sidenav__list">
                        ...
                        <li class="sidenav__item sidenav__item--expanded">
                            ...
                            <ul class="sidenav__list">
                                ...
                                <li class="sidenav__item">
                                    <a href="<?=URLROOT?>/Product/overview/" class="sidenav__link" aria-current="page">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg"><?= $data['product']->productname; ?></h1>
        </div>
                ...
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        ...
                        <span class="color-contrast-low margin-left-xxs"
                            aria-hidden="true"><?= $data['product']->productId; ?></span>
                    </li>
        ...
        <div class="bg radius-md shadow-xs">
            <form action="<?= URLROOT; ?>/Product/update" method="post">
                <div class="padding-md">
                    ...
                    <fieldset class="margin-bottom-xl">
                        <legend class="form-legend margin-bottom-md">Product</legend>
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg" for="productname">Name</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="text" name="productname"
                                        id="productname" value="<?= $data['product']->productname; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="number" step="0.01" name="productPrice"
                                        id="productPrice" value="<?= $data['product']->productPrice; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="productOwner">Customer</label>
                                </div>
                                <div class="col-6@lg">
                                    <div class="select">
                                        <select class="form-control width-100%" name="productOwner" id="productOwner"
                                            ...
                                            <option
                                                <?= ($data['product']->productOwner == $customer->customerId) ? "selected" : "" ?>
                                                value="<?= $customer->customerId ?>"><?= $customer->customerFirstName ?>
                                            </option>
                                            <?php endforeach ?>
                                        </select>
                            ...
                            <div class="select">
                                <select class="select__input form-control" name="productType" id="productType">
                                    <?php foreach ($data['productType'] as $value => $name) : ?>
                                        <option <?= ($data['product']->productType == $value) ? "selected" : "" ?> value="<?= $value ?>"><?= $name ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <svg class="icon select__icon" aria-hidden="true" viewBox="0 0 16 16">
            ...
            <form action="<?= URLROOT; ?>Product/updateImage/<?= $data['product']->productId ?>"
                    ...
                    <div class="padding-md">
                        ...
                        <fieldset class="margin-bottom-xl">
                            <div class="margin-bottom-sm">
                                <div class="grid gap-xxs">
                                    <div class="col-3@lg">
                                        <label class="inline-block text-sm padding-top-xs@lg" for="file">Add
                                            screen</label>
                                    </div>
                                    <div class="col-6@lg">
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1"
        ...
        <footer class="margin-top-md">
            <div class="flex justify-end gap-xs flex-wrap">
                ...
                <a href="<?= URLROOT; ?>Product/deleteImage/<?= $data['image']->screenId . "+" . $data['product']->productId ?>" class="btn btn--accent">Delete</a >
            </div>
        </footer>
    </div>
</div>
