...
<div class="app-ui js-app-ui">
                    ...
                    <ul class="sidenav__list">
                        ...
                        <li class="sidenav__item sidenav__item--expanded">
                            ...
                            <ul class="sidenav__list">
                                ...
                                <li class="sidenav__item">
                                    <a href="<?=URLROOT?>/Vehicle/overview/" class="sidenav__link" aria-current="page">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
                ...
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        ...
                        <span class="color-contrast-low margin-left-xxs"
                            aria-hidden="true"><?= $data['vehicle']->vehicleId; ?></span>
                    </li>
        ...
        <div class="bg radius-md shadow-xs">
                            ...
                            <div class="select">
                                <select class="form-control width-100%" name="vehicleStoreId" id="vehicleStoreId" required>
                                    <?php foreach ($data['store'] as $store) : ?>
                                        <option <?= ($data['vehicle']->vehicleStoreId == $store->storeId) ? "selected" : "" ?> value="<?= $store->storeId ?>"><?= $store->storeName ?></option>
                                    <?php endforeach ?>
                                </select>
                                ...
                                <div class="col-6@lg">
                                    <div class="select">
                                        ...
                                        <?php foreach ($data['vehicleType'] as $value => $name ) : ?>
                                            <option <?= ($data['vehicle']->vehicleType == $value) ? "selected" : "" ?> value="<?= $value ?>"><?= $name ?></option>
                                            <?php endforeach ?>
                                        </select>
            ...
            <form action="<?= URLROOT; ?>Vehicle/updateImage/<?= $data['vehicle']->vehicleId ?>"
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1"
        ...
        <footer class="margin-top-md">
            <div class="flex justify-end gap-xs flex-wrap">
                ...
                <a href="<?= URLROOT; ?>Vehicle/deleteImage/<?= $data['image']->screenId . "+" . $data['vehicle']->vehicleId?>" class="btn btn--accent">Delete</a>
            </div>
        </footer>
    </div>
</div>
