...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <a href="<?=URLROOT?>Vehicle/create" class="btn btn--primary">+ New vehicle</a>
        <br>
        <br>
        <!-- interactive table -->
        <div class="bg radius-md padding-md inner-glow shadow-xs">
                    ...
                    <table class="int-table__table" aria-label="Interactive table example">
                        <thead class="int-table__header js-int-table__header">
                            <tr class="int-table__row">
                                ...
                                <th class="int-table__cell int-table__cell--th int-table__cell--sort js-int-table__cell--sort"
                                    data-date-format="dd-mm-yyyy">
                                    <div class="flex items-center">
                                        <span>vehicleMaintenanceDate</span>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            ...
                            <tr class="int-table__row">
                                ...
                                <td class="int-table__cell">
                                    <a href="<?= URLROOT ?>Vehicle/update/<?= $vehicle->vehicleId ?>">update</a>
                                </td>
                                <td class="int-table__cell">
                                    <a
                                        href="<?= URLROOT ?>/Vehicle/delete/<?= $vehicle->vehicleId ?>">Delete</a>
                                </td>
                                <td class="int-table__cell">
            ...
            <div class="flex items-center justify-between padding-top-sm">
                <p class="text-sm"><?= $data['totalVehicles'] ?> Results</p>
                    ...
                    <ul class="pagination__list flex gap-xxxs">
                        ...
                        <li>
                            <span class="pagination__jumper flex items-center">
                                ...
                                <em>of <?= htmlspecialchars(ceil($data['totalVehicles'] / $data['perPage'])) ?></em>
                            </span>
                        </li>

                        <?php if ($data['currentPage'] < ceil($data['totalVehicles'] / $data['perPage'])) : ?>
                        <li>
                            <a href="?page=<?= $data['currentPage'] + 1 ?>" class="pagination__item">
                                <svg class="icon" viewBox="0 0 16 16">
