...
<div class="app-ui js-app-ui">
                    ...
                    <ul class="sidenav__list">
                        ...
                        <li class="sidenav__item sidenav__item--expanded">
                            ...
                            <ul class="sidenav__list">
                                ...
                                <li class="sidenav__item">
                                    <a href="<?=URLROOT?>/Review/overview/" class="sidenav__link" aria-current="page">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg"><?= $data['reviews']->reviewId; ?></h1>
        </div>
                ...
                <ol class="flex flex-wrap gap-xxs">
                    <li class="breadcrumbs__item">
                        ...
                        <span class="color-contrast-low margin-left-xxs"
                            aria-hidden="true"><?= $data['reviews']->reviewId; ?></span>
                    </li>
        ...
        <div class="bg radius-md shadow-xs">
                    ...
                    <fieldset class="margin-bottom-xl">
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="number" max="5" min="0"
                                        name="reviewRating" id="reviewRating"
                                        value="<?= $data['reviews']->reviewRating; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="reviewDescription">Description</label>
                                </div>

                                <div class="col-6@lg">
                                    <input class="form-control width-100%" type="text" name="reviewDescription"
                                        id="reviewDescription" value="<?= $data['reviews']->reviewDescription; ?>">
                                </div>
                            </div>
                        </div>
                    </fieldset>
            ...
            <form action="<?= URLROOT; ?>Review/updateImage/<?= $data['reviews']->reviewId ?>" method="post"
                                    ...
                                    <div class="flex flex-wrap gap-xxs items-center">
                                        <div>
                                            <h3 class="color-contrast-low">
                                                <?= !empty($images->screenScope) ? $images->screenScope : "No Scope" ?>
                                            </h3>
                                        </div>
                                        <br>
                                        <br>
                                        <div class="flex items-center">
                                            <span
                                                class="inline-block bg-success bg-opacity-20% text-xs padding-x-xxs padding-y-xxxxs radius-full"></span>
                                        </div>
                                    </div>

                                    <img class="text-xxl font-semibold color-contrast-higher" height="200px"
                                        width="100%" src="<?= $images->imagePath ?>">
                                    <br>
                                    <br>
                                    <a href="" aria-controls="dialog-delete-user-confirmation" class="btn btn-delete delete">Delete Image</a>
                                </div>
                                <?php endforeach; ?>
                            </div>
                    </fieldset>
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1"
        ...
        <footer class="margin-top-md">
            <div class="flex justify-end gap-xs flex-wrap">
                ...
                <a href="<?= URLROOT; ?>Review/deleteImage/<?= $images->screenId . "+" . $data['reviews']->reviewId ?>"
...
#scope::placeholder {
    color: #999;
    /* Set a lighter color for the placeholder text */
}
</style>
