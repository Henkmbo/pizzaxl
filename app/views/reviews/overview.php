...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <a href="<?=URLROOT?>/Review/create" class="btn btn--primary">+ New Review</a>
<br>
<br>
        <!-- interactive table -->
    ...
    <?php foreach ($data['reviews'] as $reviews) : ?>
        <tr class="int-table__row">
            ...
            <td class="int-table__cell"><?= $reviews->reviewId ?></td>
            <td class="int-table__cell"><?= $reviews->customerFirstName ?></td>
            <td class="int-table__cell"><?= $reviews->reviewRating ?></td>
            <td class="int-table__cell">
                <details>
                    <summary></summary>
            ...
            <td class="int-table__cell"><?= date('d/m/Y', $reviews->reviewCreateDate) ?></td>
            <td class="int-table__cell"><a href="<?= URLROOT ?>Review/update/<?= $reviews->reviewId ?>">update</a></td>
    ...
    <?php endforeach; ?>
            ...
            <div class="flex items-center justify-between padding-top-sm">
                <p class="text-sm"><?= $data['totalReviews'] ?> Results</p>
                    ...
                    <ul class="pagination__list flex gap-xxxs">
                        ...
                        <li>
                            <span class="pagination__jumper flex items-center">
                                ...
                                <em>of <?= htmlspecialchars(ceil($data['totalReviews'] / $data['perPage'])) ?></em>
                            </span>
                        </li>

                        <?php if ($data['currentPage'] < ceil($data['totalReviews'] / $data['perPage'])) : ?>
                        <li>
                            <a href="?page=<?= $data['currentPage'] + 1 ?>" class="pagination__item">
                                <svg class="icon" viewBox="0 0 16 16">
    ...
    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-title-1" aria-describedby="dialog-description">
      ...
      <footer class="margin-top-md">
        <div class="flex justify-end gap-xs flex-wrap">
          ...
          <a  class="btn btn--accent" href="<?= URLROOT ?>Review/delete/<?= $reviews->reviewId ?>">Delete</a>
        </div>
      </footer>
    </div>
  </div>
