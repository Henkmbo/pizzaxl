                    ...
                    <div class="grid gap-xxs">
                            ...
                            <div class="grid gap-xxs">
                                <div class="col-3@lg">
                                    <label class="inline-block text-sm padding-top-xs@lg"
                                        for="reviewCustomerId">Customer</label>
                                </div>
                                <div class="col-6@lg">
                                    <div class="select">
                                        <select class="select__input form-control" name="reviewCustomerId"
                                            id="reviewCustomerId">
                                            <?php foreach ($data['customers'] as $customers) : ?>
                                            <option value="<?= $customers->customerId ?>">
                                                <?= $customers->customerFirstName ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <svg class="icon select__icon" aria-hidden="true" viewBox="0 0 16 16">
                        ...
                        <div class="margin-bottom-sm">
                            <div class="grid gap-xxs">
                                ...
                                <div class="col-6@lg">
                                    <input class="form-control width-100%" max="5" min="1" type="number" name="reviewRating" id="reviewRating"
                                    value="">
                                </div>
                            </div>
                        </div>
...
<div data-toast-interval='2000' class="toast toast--hidden toast--top-right js-toast" role="alert" aria-live="assertive" aria-atomic="true" id="toast-1">
